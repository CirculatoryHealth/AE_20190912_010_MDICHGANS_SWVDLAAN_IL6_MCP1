...
p1 <- ggpubr::ggboxplot(AEDB.CEA, 
                  x = "AsymptSympt2G", y = "MCP1_pg_ug_2015_rank",
                  title = "MCP1 plaque [pg/ug] levels per symptom by gender", 
                  xlab = "Symptoms",
                  ylab = "MCP1 plaque [pg/ug]\n inverse-rank transformation",
                  color = "Gender",
                  palette = c("#D5267B", "#1290D9"),
...
ggsave(file = paste0(PLOT_loc, "/",Today,".AEDB.CEA.MCP1.plasma.Symptoms5G.pdf"), plot = last_plot())

rm(p1)

p1 <- ggpubr::ggboxplot(AEDB.CEA, 
                  x = "Symptoms.5G", y = "MCP1_plasma_olink_rank",
                  title = "MCP1 plasma [AU] levels per symptom by gender", 
                  xlab = "Symptoms",
                  ylab = "MCP1 plasma [AU]\n inverse-rank transformation",
                  color = "Gender",
                  palette = c("#D5267B", "#1290D9"),
...
ggsave(file = paste0(PLOT_loc, "/",Today,".AEDB.CEA.MCP1.plasma.Symptoms5G.byGender.pdf"), plot = last_plot())
...
p1 <- ggpubr::ggboxplot(AEDB.CEA, 
  ...
  # stat_compare_means(method = "wilcox.test")
ggpar(p1, legend = "bottom", legend.title = "Plaque vulnerability index")
ggsave(filename = paste0(PLOT_loc, "/", Today, ".MCP1.plaque.exp2_pgug.PlaqueVulnerabilityIndex.byGender.pdf"), plot = last_plot())
...
p1 <- ggpubr::ggboxplot(AEDB.CEA, 
  ...
  # stat_compare_means(method = "wilcox.test")
ggpar(p1, legend = "bottom", legend.title = "Plaque vulnerability index")
ggsave(filename = paste0(PLOT_loc, "/", Today, ".MCP1.plaque.exp2_pgug.PlaqueVulnerabilityIndex_Facet_byYear.byGender.pdf"), plot = last_plot())
